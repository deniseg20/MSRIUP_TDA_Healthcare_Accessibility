...
class PublicTransportDistanceMatrix:
    ...
    def create_public_transport_request(self, origin: Dict, destination: Dict) -> Dict:
        return {
            ...
            "travelMode": "TRANSIT",
            "departureTime": "2025-07-14T08:00:00Z",
...
# Fill matrices with calculated values
    ...
    def save_public_transport_matrices(self, duration_matrix: np.ndarray, distance_matrix: np.ndarray, 
        ...
        np.save(f"{output_dir}/public_transit_duration_matrix_411_35.npy", duration_matrix)
        np.save(f"{output_dir}/public_transit_distance_matrix_411_35.npy", distance_matrix)
